...
namespace _Game.Scripts.Inventory
{
    ...
    public class InventoryObject : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        public void AddItem(BaseItemObject _item, int amount)
        {
            ...
            Container.Add(new InventorySlot(database.GetId[_item], _item, amount));
        }
    ...
    public class InventorySlot
    {
        ...
        public InventorySlot(int _id, BaseItemObject _item, int _amount)
        {
            ID = _id;
            item = _item;
            amount = _amount;
